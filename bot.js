...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("http://imgur.com/a/z4EMDAV");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://giphy.com/gifs/lol-vine-deez-nuts-kQY6ulDGPs9r2");
    this.res.end();
  } 
    ...
    postMessage("http://www.daddyleagues.com/UnitedFL/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://bit.ly/UFLLeagueRules");
    this.res.end();
  } 
    ...
    postMessage("http://www.daddyleagues.com/UnitedFL/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/UnitedFL/players?name="+rep+"&position=all&team=all");
    ...
    this.res.writeHead(200);
    postMessage("http://www.twitch.tv/cgadgetz"+request.text.substring(8,request.text.length));
    this.res.end();
  } 
  else if(request.text && botRegexSb.test(request.text)) {
    this.res.writeHead(200);
    postMessage("http://daddleagues.com/UnitedFL");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://www.daddyleagues.com/UnitedFL/schedules");
    this.res.end();
  }
